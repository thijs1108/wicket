...
To get a reference to the bundled JQuery library we used the JavaScript setting interface _IJavaScriptLibrarySettings_ and its method _getJQueryReference_.
...
<<working-with-ajax,chapter 18>> we will see how to modify it to make it AJAX-compatible.
